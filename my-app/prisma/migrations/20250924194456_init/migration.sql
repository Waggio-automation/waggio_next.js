...
CREATE TABLE "public"."Employee" (
    ...
    -- ✅ INSERT 시 누락되면 실패 방지용 DEFAULT 추가
...
-- ─────────────────────────
-- PayHistory 테이블 (UI/UX + n8n 흐름에 맞게 보강)
-- ─────────────────────────
CREATE TABLE "public"."PayHistory" (
    "id" BIGSERIAL NOT NULL,
    "employeeId" BIGINT NOT NULL,

    -- ✅ Payroll run schedule (필수)
    ...
    -- ✅ 당시 기준(스냅샷) + UI 옵션 보존
    "payTypeSnapshot"        "public"."PayType",
    "includeVacation"        BOOLEAN NOT NULL DEFAULT true,
    "hourlyRateSnapshot"     DECIMAL(65,30),
    "vacationPctSnapshot"    DECIMAL(65,30),

    -- ✅ 근무 시간 분리 저장
    "regularHours"  DECIMAL(65,30),                 -- 정규 근무
    "overtimeHours" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "holidayHours"  DECIMAL(65,30) NOT NULL DEFAULT 0,  -- 공휴일 근무 (within total)
    ...
    "vacationPay"  DECIMAL(65,30) NOT NULL DEFAULT 0,   -- 계산된 휴가비
